        ...
        >
            ...
            <div className="fm-row flex flex-col">
                <div className="fm-col2 flex-1 flex justify-center">
                    {!isMobile ? (
                        <div className={`img-desktop max-w-2xl`}>
                            <Image src={fe2FaqAccordion.src} alt="Frontend Mentor FAQ Accordion" width={5000} height={0} className="w-full h-auto rounded-xl" draggable={false} priority={true} />
                        </div>
                    ) : (
                        <div className={`img-mobile max-w-full`}>
                            <Image src={fe2FaqAccordionMobile.src} width={5000} height={0} alt="Frontend Mentor FAQ Accordion" className="w-full h-auto rounded-xl" draggable={false} priority={true} />
                        </div>
                    )}
                </div>
                <div className={`fm-col1 flex-1 ${textDirection} mt-4`}>
                    ...
                    <div className="text-sm">One of my first projects, built with vanilla JavaScript and CSS. It&apos;s a simple, responsive design that&apos;s easy to navigate and understand. The project was a great introduction to the fundamentals of web design and development.</div>
            ...
            <div className="fm-row flex flex-col">
                <div className="fm-col2 flex-1 flex justify-center">
                    {!isMobile ? (
                        <div className={`img-desktop max-w-2xl`}>
                            <Image src={fe8RoomHomepage.src} alt="Frontend Mentor Room Homepage" width={5000} height={0} className="w-full h-auto rounded-xl" draggable={false} priority={true} />
                        </div>
                    ) : (
                        <div className={`img-mobile max-w-full`}>
                            <Image src={fe8RoomHomepageMobile.src} alt="Frontend Mentor Room Homepage" width={5000} height={0} className="w-full h-auto rounded-xl" draggable={false} priority={true} />
                        </div>
                    )}
                </div>
                <div className={`fm-col1 flex-1 ${textDirection} mt-4`}>
                    <h2 className="mb-4 text-2xl text-[#f0f0f0]">
                        <strong>Room Homepage</strong>
                    </h2>
                    <div className="badges flex flex-row items-center gap-2 mb-4 justify-center">
                        <Badge label="HTML" bgColor="#f06529" />
                        <Badge label="CSS" bgColor="#2965f1" />
                    ...
                    <div className="text-sm">In my next projects, I prioritized seamless user experiences by enhancing responsiveness and functionality. I successfully implemented a dynamic image carousel, ensuring smooth transitions between desktop and mobile views.</div>
                    <div className={`mt-4 flex gap-4 flex-wrap h-[60px] items-center justify-center`}>
            ...
            <div className="mt-4 flex gap-4 flex-wrap h-[60px] items-center justify-center">
                ...
                <NewButton icon={<FaPencilRuler />} label="Frontend Mentor" url="https://www.frontendmentor.io/profile/yangxdev" />
            </div>
        </div>
    );
}
